    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm">
                <br>
                    <h3 class="text-center">TRABAJO EN MISION</h3>
                    <br>
                </div>
            ...
            <div class="row ">
                <div class="col-sm">
                    <div class="text-just">
                        <p>Desempeñando la misiòn de <?php print $data[0]->cargo; ?> devengando un salario mensual de <?php $f = new NumberFormatter("es", NumberFormatter::SPELLOUT);
                            echo $f->format($data[0]->salario); ?>  $ <?php print number_format($data[0]->salario); ?> siendo la fecha de vinculacion del  <?php print $data[0]->dia_ingreso; ?> de  <?php print $data[0]->mes_ingreso; ?> del <?php print $data[0]->anualidad_ingreso; ?>   vigente a la fecha </p>
                    </div>
